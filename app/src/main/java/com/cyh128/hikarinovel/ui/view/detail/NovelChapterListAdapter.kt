...
import com.cyh128.hikarinovel.data.model.Novel
import com.cyh128.hikarinovel.databinding.ItemChapterCcssBinding
import com.cyh128.hikarinovel.databinding.ItemChapterVcssBinding
import com.cyh128.hikarinovel.util.ResourceUtil
...
class NovelChapterListAdapter(
    ...
    override fun onBindGroupViewHolder(
        ...
        viewModel.viewModelScope.launch(Dispatchers.IO) {
            viewModel.getReadHistoryByVolume(groupPosition).collectLatest {
    ...
    override fun onBindChildViewHolder(
        ...
        viewModel.viewModelScope.launch(Dispatchers.IO) {
            viewModel.getReadHistoryByCid(novel.volume[groupPosition].chapters[childPosition].cid).collectLatest {
                withContext(Dispatchers.Main) {
                    if (it == null) {
