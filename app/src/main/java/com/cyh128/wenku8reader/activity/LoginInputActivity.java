...
public class LoginInputActivity extends AppCompatActivity implements View.OnClickListener, CompoundButton.OnCheckedChangeListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        btn = findViewById(R.id.confirm_login);
        btn.setOnClickListener(this);
        CheckBox ckb = findViewById(R.id.rememberMe);
        ckb.setOnCheckedChangeListener(this);//是否保存用户名和密码
        ...
        signUp.setOnClickListener(v -> {
            new MaterialAlertDialogBuilder(this)
                    ...
                    .setPositiveButton("前往注册", (dialog, which) -> {
                        Uri uri = Uri.parse("https://www.wenku8.net/login.php");    //设置跳转的网站
